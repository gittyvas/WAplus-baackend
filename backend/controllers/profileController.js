...
vax@vax:~/Pluse-CRM$ nano backend/middleware/verifyAuthToken.js

vax@vax:~/Pluse-CRM$ cat backend/controllers/profileController.js
...
      `SELECT google_id, displayName, email, profile_picture_url, emailNotifications, pushNotifications
